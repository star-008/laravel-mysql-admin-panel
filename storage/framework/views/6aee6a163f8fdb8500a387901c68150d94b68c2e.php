                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="<?php echo e(route('login')); ?>">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="email" value="<?php echo e($user['email']); ?>" class="form-control" required autofocus placeholder="email">
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 text-right">
                                    <a href="<?php echo e(route('register')); ?>" class="btn btn-link px-0">Go to sign up page <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </form>
                    </div>
