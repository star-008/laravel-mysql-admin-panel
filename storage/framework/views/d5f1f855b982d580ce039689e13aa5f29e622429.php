<?php $__env->startSection('content'); ?>
                ...
                <table class="table table-responsive-sm table-bordered">
                  ...
                  <?php else: ?>
                    ...
                    <tr>
                      ...
                      <td><?php echo e($activity->pay_price); ?></td>
                      <td>
                        <a href="<?php echo e(asset('upload_data').'/'.$activity->pay_realimage); ?>" target="_blank"><?php echo e($activity->pay_image); ?></a>
                      </td>
                      <td><?php echo e($str_pay_type); ?></td>
                      <td><?php echo e($activity->updated_at); ?></td>
                      <td><?php echo e($activity->user_name); ?></td>
                      <td>
                        <a href="javascript:;" class="btn btn-primary btn-edit" activity-id="<?php echo e($activity->id); ?>" assessment-id="<?php echo e($activity->assessment_id); ?>">Accept</a>
  ...
  <div class="modal fade" id="rejectModal" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <?php $__env->startSection('myscript'); ?>
      <script src="<?php echo e(asset('js/views/admin/payment_list.js')); ?>"></script>
<?php $__env->stopSection(); ?>
