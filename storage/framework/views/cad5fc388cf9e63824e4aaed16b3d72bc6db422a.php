              ...
              <tbody>
                <tr>
                  <td class="text-center">
                    <div class="avatar">
                      <img src="<?php echo e(asset('img/avatars/1.jpg')); ?>" class="img-avatar" alt="admin@bootstrapmaster.com">
                  ...
                  <td class="text-center">
                    <img src="<?php echo e(asset('img/flags/USA.png')); ?>" alt="USA" style="height:24px;">
                  </td>
                  <td>
                    <div class="clearfix">
                ...
                <tr>
                  <td class="text-center">
                    <div class="avatar">
                      <img src="<?php echo e(asset('img/avatars/2')); ?>.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
                  ...
                  <td class="text-center">
                    <img src="<?php echo e(asset('img/flags/Brazil.png')); ?>" alt="Brazil" style="height:24px;">
                  </td>
                  <td>
                    <div class="clearfix">
                      <div class="float-left">
                ...
                <tr>
                  <td class="text-center">
                    <div class="avatar">
                      <img src="<?php echo e(asset('img/avatars/3.jpg')); ?>" class="img-avatar" alt="admin@bootstrapmaster.com">
                  ...
                  <td class="text-center">
                    <img src="<?php echo e(asset('img/flags/India.png')); ?>" alt="India" style="height:24px;">
                  </td>
                  <td>
                    <div class="clearfix">
                      <div class="float-left">
                ...
                <tr>
                  <td class="text-center">
                    <div class="avatar">
                      <img src="<?php echo e(asset('img/avatars/4.jpg')); ?>" class="img-avatar" alt="admin@bootstrapmaster.com">
                  ...
                  <td class="text-center">
                    <img src="<?php echo e(asset('img/flags/France.png')); ?>" alt="France" style="height:24px;">
                  </td>
                  <td>
                    <div class="clearfix">
                      <div class="float-left">
                ...
                <tr>
                  <td class="text-center">
                    <div class="avatar">
                      <img src="<?php echo e(asset('img/avatars/5.jpg')); ?>" class="img-avatar" alt="admin@bootstrapmaster.com">
                      <span class="avatar-status badge-success"></span>
                    </div>
                  </td>
                  <td>
                  ...
                  <td class="text-center">
                    <img src="<?php echo e(asset('img/flags/Spain.png')); ?>" alt="Spain" style="height:24px;">
                  </td>
                  <td>
                    <div class="clearfix">
                      <div class="float-left">
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <img src="<?php echo e(asset('img/flags/Poland.png')); ?>" alt="Poland" style="height:24px;">
                  </td>
                  <td>
                    <div class="clearfix">
                      <div class="float-left">
