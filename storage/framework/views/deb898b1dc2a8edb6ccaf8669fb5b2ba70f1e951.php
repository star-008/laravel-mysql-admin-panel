<?php $__env->startSection('content'); ?>
  <div class="container-fluid">
    <div class="animated fadeIn">
      <div class="row">
        <div class="col-md-12">
          <form action="<?php echo e(route('assessment.register')); ?>" method="post" enctype="multipart/form-data" class="form-assessment">
                    ...
                    <div class="row">
                      <div class="form-group col-sm-6">
                        <select id="citizenship" name="citizenship" class="form-control">
                          <?php $__currentLoopData = $country_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($idx); ?>"><?php echo e($country); ?></option>
            ...
            <input type="text" name="assessment_type" value="0" hidden>
          </form>
        </div>
      </div>
    </div>
