					...
					<div class="card">
						...
						<div class="card-body">
							<form id="mainForm" name="mainForm" class="form" method="POST">
								...
								<table class="table table-responsive-sm table-bordered">
									...
									<?php else: ?>
										...
										<tr>
											...
											<td>
												<a href="javascript:;" class="btn btn-primary btn-open-accept" data-activity-id="<?php echo e($item->id); ?>">Accept</a>
												<a href="javascript:;" class="btn btn-danger btn-open-reject" data-activity-id="<?php echo e($item->id); ?>">Reject</a>
											</td>
										</tr>
										<?php
										$index ++;
								...
								<?php echo $__env->make('common.paginator', ['paginator' => $list], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
							</form>
						</div>
					</div>
				</div>
...
<?php $__env->startSection('myscript'); ?>
	<script src="<?php echo e(asset('js/views/admin/assessment_list.js')); ?>"></script>
<?php $__env->stopSection(); ?>
