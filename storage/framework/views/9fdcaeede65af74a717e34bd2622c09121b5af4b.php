				...
				<div class="card mx-4">
					<div class="card-body p-4">
						...
						<?php if (!empty($msg_code) && $msg_code == 'register_success') { ?>
							...
							<a href="<?php echo e(route('login')); ?>" class="btn btn-block btn-secondary mt-2"><i class="fa fa-arrow-circle-left"></i> Go to sign in page</a>
						<?php } else { ?>
							...
							<a href="<?php echo e(route('login')); ?>" class="btn btn-block btn-secondary mt-2">You have already an account? Sign in</a>
						<?php } ?>
					</div>
				</div>
			</div>
