	                			...
	                			<div class="confirm-policy">
	                				<div class="confirm-policy">
			                            <label for="confirm-policy">		                              
			                              <input type="checkbox" id="confirm-policy-visa" name="educational-consultation" value="1">
			                              <span>I am confirm all</span>			                              
		                            	</label>
		                            	<button disabled="true" class="btn btn-lg btn-primary btn-confirm-policy-visa">Next</button>
		                            </div>
	                			</div>
	                		</div>
						</div>
...
<?php $__env->startSection('myscript'); ?>
	<script src="<?php echo e(asset('js/views/user/policy.js')); ?>"></script>
<?php $__env->stopSection(); ?>
