										...
										<?php else: ?>
											...
											?>
												<tr>
													...
													<td>
														<a href="javascript:;" class="btn btn-primary btn-edit" data-id="<?php echo e($category->id); ?>">Edit</a>
	...
	<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form name="editForm" id="editForm" method="post" action="<?php echo e(url('/admin/university_category/save')); ?>">
...
<?php $__env->startSection('myscript'); ?>
	<script src="<?php echo e(asset('js/views/admin/university_category.js')); ?>"></script>
<?php $__env->stopSection(); ?>
