...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  <?php echo $__env->make('core.navbar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  
  <div class="app-body">
    <?php echo $__env->make('core.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <!-- Main content -->
    <main class="main">

      <!-- Breadcrumb -->
      <?php echo $__env->make('core.breadcrumb', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

      <?php echo $__env->yieldContent('content'); ?>
      <!-- /.container-fluid -->
    </main>

    <?php echo $__env->make('core.asidemenu', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

  </div>

  <?php echo $__env->make('core.footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

  <?php echo $__env->make('core.scripts', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
